package quanlythongtin.controller;
...
import quanlythongtin.service.CustomerService;
import quanlythongtin.service.CustomerServicelmpl;
...
public class CustomerController {
    ...
    public String create(Model model){
        model.addAttribute("custome", new Customer());
        return "create";
    }
